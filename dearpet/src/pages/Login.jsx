...
export default function Login({ setIsLoggedIn, setUserId }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch("http://3.34.219.248:8080/api/auth/login", { 
        method: 'POST',
        headers: {
  ...
  const handleGoogleLogin = () => {
    window.location.href = "http://3.34.219.248:8080/oauth2/authorization/google";
  };

  const handleKakaoLogin = () => {
    window.location.href = "http://3.34.219.248:8080/oauth2/authorization/kakao";
  };
