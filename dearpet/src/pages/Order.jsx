...
const Order = () => {
    ...
    const fetchUser = async () => {
        const response = await fetch("https://3.34.219.248:8080/api/profile", {
            method: 'GET',
            headers: {
    ...
    const proceedPay = () => {
        ...
        $.ajax({
            url: "https://3.34.219.248:8080/api/verification/prepare",
            type: "POST",
            async: true,
            dataType: "json",
    ...
    const requestPay = (data) => {
        ...
        function (rsp) {
            if (rsp.success) {
                $.ajax({
                url: "https://3.34.219.248:8080/api/verification/confirm",
                method: "POST",
                dataType: "json",
                contentType: "application/json",
                headers: {
    ...
    const succeedPay = (impUid, merchantUid) => {
        fetch("https://3.34.219.248:8080/api/payments/save", {
            method: "POST",
            headers: {
                'Content-Type': 'application/json',
                'Authorization': `Bearer ${accessToken}`,
    ...
    const cartCheckout = async (impUid) => {
        try {
            ...
            const baseUrl = `https://3.34.219.248:8080/api/orders/checkout?impUid=${impUid}`;
