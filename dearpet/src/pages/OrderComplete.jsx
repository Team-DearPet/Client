...
export default function OrderComplete() {
  ...
  useEffect(() => {
    if (impUid) {
      ...
      axios
        .get(`https://3.34.219.248/api/payments/${impUid}`, {
          headers: {
  ...
  const { buyerName, buyerTel, buyerAddr, cardName, amount, paidAt, name } =
    paymentInfo;
  return (
    <div style={{ minHeight: "100vh" }}>
      ...
      >
        <Box className="container" style={{ width: "100%" }}>
          ...
          >
            <CheckCircleIcon
              style={{ fontSize: "70px", color: "#DC0044", marginTop: "50px" }}
            />
            <Typography
              style={{
                marginTop: "20px",
            ...
            >
              {buyerName}님이 구매하신 상품은{" "}
              {new Date(paidAt).toLocaleDateString("ko-KR", {
                year: "numeric",
                month: "long",
                day: "numeric",
              })}
